...
public class CreateCampaignTestUsingPropertyFile 
{
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		driver.findElement(By.name("campaignName")).sendKeys("Banner1201");

		driver.findElement(By.name("targetSize")).clear();

		driver.findElement(By.name("targetSize")).sendKeys("1020");
		...
		if(ConfMsg.contains("Banner1201"))
